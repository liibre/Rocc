...
Still deciding the output. The columns `synonym` and `scientificName_original` were additioned by hand inside function, other columns are exactly the same as in the API of Brazilian Flora 2020. 
